...
class OneDriveNameTest extends TestCase
{
    ...
    const OG_COENV_FISCAL_URL = 'https://uwnetid-my.sharepoint.com/personal/nbedani_uw_edu/_layouts/15/onedrive.aspx?id=%2Fpersonal%2Fnbedani%5Fuw%5Fedu%2FDocuments%2Fuwenv%5Ftreq/treq/jones,%20lydia?csf=1&web=1&e=xdac6a';
    ...
    public function test_it_returns_last_section_of_og_coe_fiscal_url()
    {
        ...
        $result = $it->name(self::OG_COENV_FISCAL_URL);
