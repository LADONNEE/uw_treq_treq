<div style="max-width: 600px;font-family:Arial,Helvetica,sans-serif; font-size:16px; text-align:center;">
    ...
    <p>
        This email notification was generated by the University of Washington, Information School's {{ $appName }}.
        If you have trouble with this notification or have received this message in error, please contact the Information School at <strong>itreq@uw.edu</strong>.
    </p>
</div>
