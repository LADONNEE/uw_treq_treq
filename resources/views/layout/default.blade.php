...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('css/app.css') }}{{ $cacheBusting = '?v=' . config('view.resource_cache') }}" media="all" />
    <link rel="stylesheet" type="text/css" href="/treq/uworg-util/css/env-warning.css" type="text/css" media="all" />
    <script defer src="{{ asset('js/app.js') }}{{ $cacheBusting }}"></script>
