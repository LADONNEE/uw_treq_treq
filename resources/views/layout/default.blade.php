...
<head>
    ...
    <title>@yield('title') - TREQ - COE - UW</title>
    ...
    <link rel="stylesheet" type="text/css" href="/coe-util/css/env-warning.css" type="text/css" media="all" />
    ...
    <script defer type="text/javascript" src="/coe-util/js/env-warning.js"></script>
